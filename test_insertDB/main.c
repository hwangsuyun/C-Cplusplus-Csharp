...
{12,4130,840,0,0,
5,0,0,1,0,0,27,48,0,0,4,4,0,1,0,1,97,0,0,1,97,0,0,1,97,0,0,1,10,0,0,
36,0,0,2,0,0,32,53,0,0,0,0,0,1,0,
51,0,0,3,152,0,3,59,0,0,7,7,0,1,0,1,3,0,0,1,97,0,0,1,97,0,0,1,3,0,0,1,97,0,0,1,
97,0,0,1,97,0,0,
94,0,0,4,0,0,32,68,0,0,0,0,0,1,0,
109,0,0,5,0,0,30,73,0,0,0,0,0,1,0,
};
...
struct { unsigned short len; unsigned char arr[9]; } ERR_DATE;

	/* VARCHAR ERR_PLACE[200+1]; */ 
struct { unsigned short len; unsigned char arr[201]; } ERR_PLACE;

	int ERROR_LEVEL;
	/* VARCHAR ERROR_CONTENTS[200+1]; */ 
struct { unsigned short len; unsigned char arr[201]; } ERROR_CONTENTS;

	/*VARCHAR CREATE_DATE[8+1];*/
	/* VARCHAR CREATE_BY[10+1]; */ 
struct { unsigned short len; unsigned char arr[11]; } CREATE_BY;

	/*VARCHAR LAST_UPDATE_DATE[8+1];*/
	/* VARCHAR LAST_UPDATE_BY[10+1]; */ 
struct { unsigned short len; unsigned char arr[11]; } LAST_UPDATE_BY;
...

{
  ...
  sqlstm.sqladtp = &sqladt;
  sqlstm.sqltdsp = &sqltds;
  sqlstm.stmt = "insert into MT_EDI_ERRORLOG (ERR_NO,ERR_DATE,ERR_PLACE,ERR\
OR_LEVEL,ERROR_CONTENTS,CREATE_BY,LAST_UPDATE_BY) values ((:b0+1),:b1,:b2,(:b\
0+1),:b4,:b5,:b6)";
  sqlstm.iters = (unsigned int  )1;
  ...
  sqlstm.sqadto[0] = (unsigned short )0;
  sqlstm.sqtdso[0] = (unsigned short )0;
  sqlstm.sqhstv[1] = (         void  *)err_date[i];
  ...
  sqlstm.sqadto[1] = (unsigned short )0;
  sqlstm.sqtdso[1] = (unsigned short )0;
  sqlstm.sqhstv[2] = (         void  *)err_place[i];
  ...
  sqlstm.sqhstv[4] = (         void  *)error_contents[i];
  ...
  sqlstm.sqhstv[5] = (         void  *)create_by[i];
  ...
  sqlstm.sqhstv[6] = (         void  *)last_update_by[i];
