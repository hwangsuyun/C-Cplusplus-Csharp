...
int main(void)
{
	...
	struct FtpFile ftpfile={
		fileNm, /* name to store the file as if successful */ 
		NULL
	};
	memcpy(fileNm, "test.txt", sizeof(fileNm));
	...
	if(curl) {
		 ...
		 */ 
		curl_easy_setopt(curl, CURLOPT_URL, "ftp://smw:smw@133.9.100.5/");
